    ...
    return (
        <div className="flex flex-col gap-1 w-full max-w-[300px]">
            ...
            <div
                ...
                className="bg-slate-900 rounded-xl overflow-hidden border border-slate-800 cursor-pointer hover:border-purple-500/50 transition shadow-md group relative h-32 flex w-full"
            >
                ...
                {/* Quick Action Button - Only if Checked In (Enter Queue) */}
                {isCheckedInHere && (
                    <button
                        onClick={(e) => {
                            e.stopPropagation();
                        ...
                        className="p-2.5 rounded-full shadow-lg transition-all active:scale-95 flex items-center justify-center bg-purple-600 text-white hover:bg-purple-500 border border-purple-500 hover:border-purple-400"
                        title="Enter Event"
                    >
